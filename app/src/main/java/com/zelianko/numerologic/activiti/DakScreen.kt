...
fun TextBlockForDak(header: Int, matrix: HashMap<String, String>?) {
    ...
    when (header) {
        ...
        4 -> {
            ...
            title = "Логика ${matrix?.get("Логика")} + Память ${matrix?.get("Память")} + Семья ${
                matrix?.get("Семья")
            }"
        }
        ...
        15 -> {
            ...
            title =
                "Цель ${matrix?.get("Цель")} + Быт ${matrix?.get("Быт")} + Семья ${matrix?.get("Семья")}"
        }
        ...
        22 -> {
            ...
            title = "Здор ${matrix?.get("Здоровье")}/Память ${matrix?.get("Память")}/Долг ${
                matrix?.get("Долг")
            }/Ин ${matrix?.get("Интерес")}"
        }
        ...
        30 -> {
            ...
            title =
                "Темп.${matrix?.get("Темперамент")}/Эн.${matrix?.get("Энергия")}/Долг${matrix?.get("Долг")}/Семья${
                    matrix?.get("Семья")
                }"
        }
        ...
        31 -> {
            ...
            title =
                "Темп.${matrix?.get("Темперамент")}/Дл.${matrix?.get("Долг")}/Семья${matrix?.get("Семья")},Цель/Скрытая цель"
        }
